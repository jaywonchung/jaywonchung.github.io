...
$$ \frac{\partial L}{\partial \mathbf{W}_i}=\frac{\partial L}{\partial \tilde{\mathbf{W}_i}}\left(\frac{1}{n} + \frac{\partial \text{sign}}{\partial \mathbf{W}_i}\alpha \right)$$

where $$\tilde{\mathbf{W}}=\alpha \mathbf{B}$$, the estimated value of $$\mathbf{W}$$.
